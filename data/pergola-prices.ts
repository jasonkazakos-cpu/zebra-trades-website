...
export const GALLERY_ITEMS: { label: string; typeKey: TypeKey; description: string; image?: string; priceOverride?: string }[] = [
  { label: "Timber Garden Pergola", typeKey: "timber", description: "A classic timber pergola — ideal for climbing plants and natural charm.", image: "/images/pergolas/timber-pergola-small-hertfordshire.webp", priceOverride: "From £2,495 Installed" },
  { label: "Aluminium Pergola", typeKey: "aluminium", description: "Low-maintenance aluminium frames in a range of powder-coated finishes. Large size with flexible additions.", image: "/images/pergolas/aluminium-pergola-wall-mounted-large-cuffley.webp", priceOverride: "From £4,495 Installed" },
  ...
  { label: "Louvered Roof Pergola", typeKey: "louvered", description: "Adjustable louvres give you full control of shade and ventilation.", image: "/images/pergolas/louvered-roof-pergola-deponti-pinela.webp", priceOverride: "From £8,999 Installed" },
