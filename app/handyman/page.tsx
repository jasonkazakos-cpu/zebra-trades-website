...
const categories: PricingCategory[] = [
  {
    ...
    icon: "Hammer",
    items: [
      { name: "Internal Door Fitting (hollow door)", price: "£120" },
      { name: "Internal Door Fitting (solid wood door)", price: "£140" },
      { name: "Door Trimming (first door)", price: "£75" },
      { name: "Subsequent Door Trimming", price: "£30" },
      { name: "Door Handle Replacement (first handle)", price: "£75" },
      { name: "Subsequent Door Handle Replacement", price: "£25" },
      { name: "Lock Replacement (first lock)", price: "£75" },
      { name: "Subsequent Lock Replacement (per door)", price: "£25" },
      { name: "Skirting Board Repairs (first hour call out)", price: "£75" },
      { name: "Skirting Board Repairs (per hour)", price: "£45" },
      { name: "Skirting Board Installation (first hour)", price: "£75" },
      { name: "Skirting Board Installation (hourly rate)", price: "£45" },
      { name: "Architrave Repairs (first hour call out)", price: "£75" },
      { name: "Shelving Installation (first hour call out)", price: "£75" },
      { name: "Shelving Installation (after first hour)", price: "£45" },
      { name: "Flat Pack Furniture Assembly (first hour call out)", price: "£75" },
      { name: "Flat Pack Furniture Assembly (second hour onwards)", price: "£45" },
      { name: "Wardrobe Assembly (first hour call out)", price: "£75" },
      { name: "Wardrobe Assembly (second hour onwards)", price: "£45" },
      { name: "Odd Jobs (first hour)", price: "£75" },
      { name: "Odd Jobs (second hour onwards)", price: "£45" },
      { name: "Half Day (4 hours)", price: "£185" },
      { name: "Full Day (8 hours incl. tidy up time)", price: "£320" },
    ],
  },
  {
    title: "TV & Smart Home",
    icon: "PlugZap",
    items: [
      { name: "TV Wall Mounting on plasterboard wall — reinforce wall up to 55\"", price: "POA" },
      { name: "TV Wall Mounting on plasterboard wall lightweight up to 55\"", price: "£120" },
      { name: "TV Wall Mounting on brick wall up to 55\"", price: "£120" },
      { name: "TV Wall Mounting over 55\"", price: "£140" },
      { name: "Large Mirror Installation", price: "£120" },
      { name: "Smart Doorbell Installation", price: "£75" },
      { name: "Security Camera Installation wireless battery powered (call out)", price: "£75" },
      { name: "Security Camera Installation wireless battery powered (subsequent per hour)", price: "£45" },
    ],
  },
  {
    title: "Gates & Fencing",
    ...
    items: [
      ...
      { name: "Replace Concrete Fence Post", price: "From £165" },
      { name: "Replace Concrete Gravel Board", price: "From £110" },
      { name: "Replace Garden Gate", price: "From £120" },
      { name: "Fence Repairs", price: "From £95" },
      { name: "New Fence Installation", price: "From £295 per 6ft section + materials" },
      { name: "Heavy Duty Closeboard Fencing", price: "From £315 per 6ft section + materials" },
      { name: "Premium Closeboard Fencing", price: "From £335 per 6ft section + materials" },
    ],
